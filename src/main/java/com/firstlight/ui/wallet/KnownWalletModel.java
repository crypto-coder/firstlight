...
public class KnownWalletModel extends DefaultFXMLModel<KnownWalletModel> {
    ...
    private Integer MaxKnownWallets = (Integer) ResourceBuilders.PARAMETER_BUILDER.get(FirstLightParameters.MaxKnownWalletLocationCount);
    ...
    protected void fxmlPreInitialize() {
    	...
    	for(Integer i = 0; i < this.MaxKnownWallets; i++){
    		try{
	...
	/**
	 * @return the maxKnownWallets
	 */
	public Integer getMaxKnownWallets() {
		return MaxKnownWallets;
	}

	/**
	 * @param maxKnownWallets the maxKnownWallets to set
	 */
	public void setMaxKnownWallets(Integer maxKnownWallets) {
		MaxKnownWallets = maxKnownWallets;
	}
	 ...
	 */
	public void setKnownWalletLocations(
			HashMap<String, IWallet> knownWalletLocations) {
