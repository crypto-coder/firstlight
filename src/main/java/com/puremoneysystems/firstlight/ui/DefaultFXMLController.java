 ...
 */
public class DefaultFXMLController<M extends Model> extends AbstractFXMLController<M, View<M, AnchorPane, DefaultFXMLController<M>>> implements Controller<M, View<M, AnchorPane, DefaultFXMLController<M>>> {
...
//implements FXMLController<M, View<M, AnchorPane, DefaultFXMLController<M>>>, Controller<M, View<M, AnchorPane, DefaultFXMLController<M>>> {
    ...
    private View<M, AnchorPane, DefaultFXMLController<M>> innerView = null;
     ...
     * @throws CoreException if an error occurred while creating event handlers
     */
    public DefaultFXMLController(final View<M, AnchorPane, DefaultFXMLController<M>> view) throws CoreException {
    	this.innerView = view;
    }
